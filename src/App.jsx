      ...
      steps: [
        {
          ...
          supportChannels: ['inbound', 'outbound', 'email'],
          channelDescription: 'All communication channels - facilitation between injured workers, insurers, and internal teams',
        },
      ],
    },
    {
      ...
      steps: [
        {
          ...
          supportChannels: ['inbound', 'voicemail'],
          channelDescription: 'Inbound calls from injured workers and inquiries, voicemail overflow',
        },
      ],
    },
  ];
